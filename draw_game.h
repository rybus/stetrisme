...
void draw_game(SDL_Surface *screen, Block grid[][VERTICAL_BLOCK_NB], Tetromino_t, int next_tetromino_type, Config_t config, int score, int level, int color_reversed);
